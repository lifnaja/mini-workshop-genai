...
df = pd.read_csv('example_tranform/carbon_credit_buyers.csv')

df['certification_date_parsed'] = df['certification_date'].apply(parse_thai_date)
print(df[['certification_date_parsed', 'certification_date']])
